                                        ...
                                        {!myVote ? (
                                            <>
                                                <textarea
                                                    ...
                                                    className="w-full px-3 py-2 rounded-lg border border-slate-200 text-sm bg-white focus:border-teal-500 outline-none mb-3"
                                                    rows={2}
                                                />
        ...
        <div className="space-y-3">
                        ...
                        return (
                            <div key={it.id} className="bg-slate-50 rounded-xl p-3">
                                <div className="flex items-center gap-2 mb-1">
                                    ...
                                    {u && (
                                        <a href={u} target="_blank" rel="noopener noreferrer" className="text-xs font-semibold text-teal-700 hover:underline shrink-0">Abrir ↗</a>
                                    )}
            ...
            {uploadBlockedReason ? (
                ...
                <div className="bg-white border border-dashed border-slate-300 rounded-xl p-3 space-y-2">
                    ...
                    />
                    <label className={`flex items-center justify-center gap-2 rounded-lg px-3 py-2.5 text-sm font-semibold cursor-pointer transition ${uploading ? 'bg-slate-100 text-slate-400' : 'bg-teal-600 text-white hover:bg-teal-700'}`}>
                        <FileText size={15} />
        ...
        <div className="bg-slate-50 rounded-xl p-3">
            ...
            {!error && resolvedUrl && !isImage && (
                <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="block bg-white border border-slate-200 rounded-lg p-3 text-center text-sm font-semibold text-teal-700 hover:bg-slate-50"
                >
                    Abrir comprobante
                </a>
            )}
