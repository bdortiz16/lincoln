    ...
    <div className="fixed inset-0 z-[70] flex items-center justify-center p-4 animate-in fade-in duration-300">
      ...
      <div className="relative bg-white rounded-3xl shadow-2xl w-full max-w-md p-6 md:p-10 animate-in zoom-in-95 duration-300">
        ...
        <div className="space-y-3 mb-6">
          ...
          >
            <div className="w-10 h-10 flex items-center justify-center shrink-0">
              <svg viewBox="0 0 24 24" className="w-8 h-8" fill="none">
                <path d="M3.609 1.814L13.792 12 3.609 22.186a.996.996 0 01-.609-.92V2.734a1 1 0 01.609-.92z" fill="#4ADE80"/>
                <path d="M16.81 15.012L6.05 21.2l8.99-8.99 1.77 2.802z" fill="#4ADE80" opacity="0.7"/>
                <path d="M20.16 10.81c.5.31.5 1.06 0 1.38l-3.34 1.93-2.04-2.62 2.04-2.62 3.34 1.93z" fill="#4ADE80"/>
                <path d="M6.05 2.79l10.76 6.19-1.77 2.8L6.05 2.79z" fill="#4ADE80" opacity="0.85"/>
              </svg>
            </div>
          ...
          >
            <div className="w-10 h-10 flex items-center justify-center shrink-0">
              <svg viewBox="0 0 24 24" className="w-8 h-8" fill="#4ADE80">
