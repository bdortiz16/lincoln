  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-[#F4F6F9] px-4 py-12">
      ...
      <button
        ...
        disabled={checking}
        className="w-full max-w-xs h-12 bg-[#0C0E0D] hover:bg-[#161A17] disabled:opacity-60 font-bold rounded-lg transition-colors shadow-lg shadow-green-900/20 mb-6 flex items-center justify-center gap-2"
      >
        {checking ? (
