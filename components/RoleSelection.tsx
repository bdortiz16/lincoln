      ...
      <div className="fixed inset-0 z-[60] flex items-center justify-center p-4 animate-in fade-in duration-300">
        ...
        <div className="relative bg-white rounded-3xl shadow-2xl w-full max-w-4xl max-h-[90vh] flex flex-col overflow-hidden animate-in zoom-in-95 duration-300">
          ...
          <div className="p-5 md:p-16 flex flex-col items-center overflow-y-auto">
              ...
              <h2 className="text-xl md:text-4xl font-bold text-[#0C0E0D] text-center mb-2 md:mb-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-3 md:gap-8 w-full max-w-3xl">
                  ...
                  >
                      {/* "App móvil" badge */}
                      <div className="absolute top-3 right-3 md:top-4 md:right-4 bg-[#4ADE80]/10 text-[#0C0E0D] text-[9px] md:text-[10px] font-bold px-2 py-1 rounded-full border border-[#4ADE80]/30">
                          📱 APP MÓVIL
                      </div>
                      ...
                      <div className="role-circle-teal w-12 h-12 md:w-24 md:h-24 rounded-full bg-slate-50 flex items-center justify-center mb-3 md:mb-6 group-hover:bg-[#4ADE80] transition-all duration-300 shadow-sm group-hover:scale-110 shrink-0">
                          <User className="w-6 h-6 md:w-10 md:h-10 text-slate-900 group-hover:text-[#0C0E0D] transition-colors duration-300" strokeWidth={2} />
                      </div>

                      <h3 className="text-lg md:text-2xl font-bold text-slate-800 mb-1 md:mb-2 group-hover:text-[#0C0E0D]">Personas</h3>
                      ...
                      <div className="mt-auto flex items-center gap-2 text-[#0C0E0D] font-bold text-xs md:text-sm">
                  ...
                  <button
                      ...
                      className="role-card group relative bg-white border-2 border-slate-100 rounded-2xl md:rounded-3xl p-4 md:p-8 hover:border-[#0C0E0D] hover:shadow-2xl transition-all duration-300 flex flex-col items-center text-center text-left"
                  >
                      <div className="role-circle-dark w-12 h-12 md:w-24 md:h-24 rounded-full bg-slate-50 flex items-center justify-center mb-3 md:mb-6 group-hover:bg-[#0C0E0D] transition-all duration-300 shadow-sm group-hover:scale-110 shrink-0">
                      ...
                      <h3 className="text-lg md:text-2xl font-bold text-slate-800 mb-1 md:mb-2 group-hover:text-[#0C0E0D]">Empresas</h3>
                      <p className="text-slate-500 text-[10px] md:text-sm leading-relaxed mb-3 md:mb-6">
                          Gestiona pagos a proveedores, planilla y cobranzas masivas.
                      </p>

                      <div className="mt-auto flex items-center gap-2 text-[#0C0E0D] font-bold text-xs md:text-sm opacity-100 md:opacity-0 md:group-hover:opacity-100 transition-opacity transform md:translate-y-2 md:group-hover:translate-y-0">
                          Ingresar <ChevronRight size={14} className="md:w-4 md:h-4" />
                      </div>

                      {/* Checkmark badge on hover (Desktop only) */}
                      <div className="absolute top-4 right-4 w-6 h-6 rounded-full bg-[#0C0E0D] items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity hidden md:flex">
          ...
          <div className="bg-slate-50 py-3 md:py-4 px-4 md:px-8 text-center text-[10px] md:text-xs text-slate-400 border-t border-slate-100 shrink-0">
              ¿No eres cliente? <button onClick={onSelectPersonal} className="text-[#0C0E0D] font-bold hover:underline">Abre tu cuenta aquí</button>
          </div>
        </div>
      </div>
  );
